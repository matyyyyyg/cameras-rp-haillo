...
class InsightFaceClassifier:
    ...
    def classify_face(self, face_crop: np.ndarray) -> Optional[ClassificationResult]:
        ...
        try:
            ...
            # InsightFace needs at least ~160x160 for optimal results
            min_size = 160
            ...
            # InsightFace provides gender as 0 or 1, use fixed high confidence
            # The old formula was buggy: abs(x-0.5)*2+0.5 always gives 0.5-1.0
